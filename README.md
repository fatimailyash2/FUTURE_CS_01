...
This task presents a vulnerability assessment perfomed on Google Gruyere, a web application designed by Google, specifically for security research. It integrates multiple typical vulnerabilities, covering cross-site scripting (XSS), cross-site request forgery (CSRF), and access control flaws. 
